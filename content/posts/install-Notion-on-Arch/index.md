...
tags: ["Arch"]
series: ["Let's Linux!"]
description: "Instructions to install Notion on Arch Linux include using the command sudo pacman -S epiphany and referencing the ArchWiki page for Notion-app."
...
> **Summary**
> Instructions to install Notion on Arch Linux include using the command sudo pacman -S epiphany and referencing the ArchWiki page for Notion-app.
