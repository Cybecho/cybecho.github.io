...
tags: ["Util"]
series: ["오픈소스"]
description: "'모두의 프린터'는 가상 프린터 프로그램으로, 인쇄 명령을 PDF 파일이나 이미지 파일로 변환해줍니다. OPIc 성적표와 같은 특정 사이트에서 보안상의 이유로 인쇄가 불가능할 때, IP 대역을 변경하여 문제를 해결할 수 있는 방법을 제공합니다. 이 프로그램을 통해 프린터 없이도 문서 작업을 자유롭게 할 수 있습니다."
...
> **Summary**
> '모두의 프린터'는 가상 프린터 프로그램으로, 인쇄 명령을 PDF 파일이나 이미지 파일로 변환해줍니다. OPIc 성적표와 같은 특정 사이트에서 보안상의 이유로 인쇄가 불가능할 때, IP 대역을 변경하여 문제를 해결할 수 있는 방법을 제공합니다. 이 프로그램을 통해 프린터 없이도 문서 작업을 자유롭게 할 수 있습니다.
