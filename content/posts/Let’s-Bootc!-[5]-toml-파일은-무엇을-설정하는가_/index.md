---
title: "Let’s Bootc! [5] - toml 파일은 무엇을 설정하는가?"
date: 2026-01-25T07:22:00.000Z
draft: false
tags: ["Docker", "Infra"]
series: ["Meet The Bootc"]
description: "toml 파일은 bootc-image-builder가 디스크 이미지를 생성할 때 적용할 커스터마이징을 정의하며, 사용자 계정, SSH 키, 파티션 레이아웃, 커널 파라미터, kickstart 스크립트 삽입 등의 주요 설정 항목이 포함된다. 설정은 최초 설치 시 "
notion_id: "2f31bab9-e3f8-8075-b164-d30b0f8c8050"
notion_url: "https://www.notion.so/Let-s-Bootc-5-toml-2f31bab9e3f88075b164d30b0f8c8050"
---

# Let’s Bootc! [5] - toml 파일은 무엇을 설정하는가?

> **Summary**
> toml 파일은 bootc-image-builder가 디스크 이미지를 생성할 때 적용할 커스터마이징을 정의하며, 사용자 계정, SSH 키, 파티션 레이아웃, 커널 파라미터, kickstart 스크립트 삽입 등의 주요 설정 항목이 포함된다. 설정은 최초 설치 시 

---

![Image](image_389bf1ef2d17.png)

![Image](image_a2b31014d9fe.png)

# [5] toml 파일은 무엇을 설정하는가?
