...
description: "DNS의 기본 원리와 Public DNS 및 Private DNS의 사용 방식에 대해 설명하며, 윈도우 VM과 우분투 서버 간의 DNS 쿼리 흐름을 분석합니다. 각 서버의 역할을 이해하고, DNS 요청 처리 과정에서의 상호작용을 통해 네트워크 문제 해결 능력을 향상시킬 수 있습니다."
...
> **Summary**
> DNS의 기본 원리와 Public DNS 및 Private DNS의 사용 방식에 대해 설명하며, 윈도우 VM과 우분투 서버 간의 DNS 쿼리 흐름을 분석합니다. 각 서버의 역할을 이해하고, DNS 요청 처리 과정에서의 상호작용을 통해 네트워크 문제 해결 능력을 향상시킬 수 있습니다.

---

![Image](image_240ec4a20c53.png)
...
![Image](image_a2c66c3457ff.png)

![Image](image_103592ce54fa.png)

![Image](image_e02e9218f00a.png)
