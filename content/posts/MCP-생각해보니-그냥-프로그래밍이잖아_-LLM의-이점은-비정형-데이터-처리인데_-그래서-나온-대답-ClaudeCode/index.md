...
tags: ["AI"]
series: ["AI"]
description: "MCP는 정형화된 프로토콜을 사용하지만, 클로드 스킬은 자연어로 간단하게 지시할 수 있는 방법을 제공한다. LLM의 본질은 자연어 이해이며, 클로드 스킬은 이를 활용하여 복잡한 프로토콜 대신 사용자가 원하는 워크플로를 자유롭게 만들 수 있게 한다. MCP는 대규모 배포에 유용하지만, 개인 워크플로와 프로토타이핑에는 클로드 스킬이 더 적합하다."
...
> **Summary**
> MCP는 정형화된 프로토콜을 사용하지만, 클로드 스킬은 자연어로 간단하게 지시할 수 있는 방법을 제공한다. LLM의 본질은 자연어 이해이며, 클로드 스킬은 이를 활용하여 복잡한 프로토콜 대신 사용자가 원하는 워크플로를 자유롭게 만들 수 있게 한다. MCP는 대규모 배포에 유용하지만, 개인 워크플로와 프로토타이핑에는 클로드 스킬이 더 적합하다.
