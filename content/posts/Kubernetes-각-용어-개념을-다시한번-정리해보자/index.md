...
description: "쿠버네티스의 주요 용어를 식당 비유로 설명하며, 클러스터는 전체 식당, 컨트롤 플레인은 주방의 두뇌, 노드는 요리가 이루어지는 곳으로 비유된다. API 서버는 주문을 받고 전달하며, 스케줄러는 요리사에게 주문을 배정하고, 컨트롤러 매니저는 운영 상태를 감시한다. 손님은 메뉴판을 통해 쉽게 주문하고, 디플로이먼트와 레플리카셋을 통해 요리의 수량과 운영 계획을 관리한다."
...
> **Summary**
> 쿠버네티스의 주요 용어를 식당 비유로 설명하며, 클러스터는 전체 식당, 컨트롤 플레인은 주방의 두뇌, 노드는 요리가 이루어지는 곳으로 비유된다. API 서버는 주문을 받고 전달하며, 스케줄러는 요리사에게 주문을 배정하고, 컨트롤러 매니저는 운영 상태를 감시한다. 손님은 메뉴판을 통해 쉽게 주문하고, 디플로이먼트와 레플리카셋을 통해 요리의 수량과 운영 계획을 관리한다.
