---
title: "Let’s Bootc! [4] - Anaconda, 너는 무엇이냐?"
date: 2026-01-25T07:18:00.000Z
draft: false
tags: ["Docker", "Infra"]
series: ["Meet The Bootc"]
description: "Anaconda는 리눅스 설치 프로그램으로, bootc는 컨테이너 이미지 배포를 위한 새로운 방식이다. Anaconda는 25년간 검증된 도구로, kickstart 파일을 통해 자동 설치를 지원한다. bootc-image-builder는 ISO 생성 시 kickstart 파일을 자동으로 생성하며, 기존 인프라와의 호환성을 유지하여 효율적인 서버 프로비저닝을 가능하게 한다. 새로운 기술 도입 시 기존의 검증된 도구를 재활용하는 것이 합리적이다."
notion_id: "2f31bab9-e3f8-8086-a1ac-d80e854ab880"
notion_url: "https://www.notion.so/Let-s-Bootc-4-Anaconda-2f31bab9e3f88086a1acd80e854ab880"
---

# Let’s Bootc! [4] - Anaconda, 너는 무엇이냐?

> **Summary**
> Anaconda는 리눅스 설치 프로그램으로, bootc는 컨테이너 이미지 배포를 위한 새로운 방식이다. Anaconda는 25년간 검증된 도구로, kickstart 파일을 통해 자동 설치를 지원한다. bootc-image-builder는 ISO 생성 시 kickstart 파일을 자동으로 생성하며, 기존 인프라와의 호환성을 유지하여 효율적인 서버 프로비저닝을 가능하게 한다. 새로운 기술 도입 시 기존의 검증된 도구를 재활용하는 것이 합리적이다.

---

![Image](image_80227b9975a2.png)

# [4] 설치할 때 anaconda는 왜 나타나는가?
