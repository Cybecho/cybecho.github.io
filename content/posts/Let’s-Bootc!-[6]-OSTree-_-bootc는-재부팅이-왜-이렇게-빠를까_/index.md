---
title: "Let’s Bootc! [6] - OSTree : bootc는 재부팅이 왜 이렇게 빠를까?"
date: 2026-01-25T10:46:00.000Z
draft: false
tags: ["Docker", "Infra"]
series: ["Meet The Bootc"]
description: "OSTree는 운영체제 바이너리의 원자적 전환을 가능하게 하여 재부팅 속도를 빠르게 하고 롤백을 쉽게 만들어준다. Git의 content-addressed 모델을 적용하여 파일의 해시값으로 관리하며, 하드링크를 사용하여 디스크 공간을 절약하고 무결성을 보장한다. 업데이트 시 변경된 객체만 다운로드되며, 시스템 충돌 시에도 이전 또는 새로운 시스템 중 하나로 부팅된다."
notion_id: "2f31bab9-e3f8-8015-b890-ff96bf889269"
notion_url: "https://www.notion.so/Let-s-Bootc-6-OSTree-bootc-2f31bab9e3f88015b890ff96bf889269"
---

# Let’s Bootc! [6] - OSTree : bootc는 재부팅이 왜 이렇게 빠를까?

> **Summary**
> OSTree는 운영체제 바이너리의 원자적 전환을 가능하게 하여 재부팅 속도를 빠르게 하고 롤백을 쉽게 만들어준다. Git의 content-addressed 모델을 적용하여 파일의 해시값으로 관리하며, 하드링크를 사용하여 디스크 공간을 절약하고 무결성을 보장한다. 업데이트 시 변경된 객체만 다운로드되며, 시스템 충돌 시에도 이전 또는 새로운 시스템 중 하나로 부팅된다.

---

![Image](image_a837030480e2.png)

![Image](image_1540ff940ffc.png)
