---
title: "Let’s Bootc! [45] - Anaconda, 너는 무엇이냐?"
date: 2026-01-25T07:18:00.000Z
draft: false
tags: ["Docker", "Infra"]
series: ["Meet The Bootc"]
description: "Anaconda는 25년간 RHEL 계열 리눅스의 표준 설치 프로그램으로, kickstart를 통해 반복 가능한 설치를 가능하게 한다. bootc-image-builder는 ISO를 생성할 때 anaconda와 kickstart를 활용하여 컨테이너 이미지를 배포하는 방식으로, 기존의 검증된 도구를 재활용하는 것이 핵심이다. 이를 통해 설치 과정의 코드화와 인프라의 재사용이 가능해진다."
notion_id: "2f31bab9-e3f8-8086-a1ac-d80e854ab880"
notion_url: "https://www.notion.so/Let-s-Bootc-45-Anaconda-2f31bab9e3f88086a1acd80e854ab880"
---

# Let’s Bootc! [45] - Anaconda, 너는 무엇이냐?

> **Summary**
> Anaconda는 25년간 RHEL 계열 리눅스의 표준 설치 프로그램으로, kickstart를 통해 반복 가능한 설치를 가능하게 한다. bootc-image-builder는 ISO를 생성할 때 anaconda와 kickstart를 활용하여 컨테이너 이미지를 배포하는 방식으로, 기존의 검증된 도구를 재활용하는 것이 핵심이다. 이를 통해 설치 과정의 코드화와 인프라의 재사용이 가능해진다.

---

![Image](image_046a25e7f054.png)
