...
tags: ["Docker", "Infra"]
series: ["Let's Bootc!"]
description: "OCI는 컨테이너 생태계의 표준을 정의하여 Docker와 Podman 등 다양한 도구에서 호환성을 제공합니다. bootc는 OCI 표준을 활용하여 기존 컨테이너 도구와 레지스트리를 그대로 사용할 수 있으며, 커널과 initramfs를 포함한 부팅 가능한 컨테이너 이미지를 제공합니다. 이를 통해 운영체제를 효율적으로 업데이트할 수 있습니다."
...
> **Summary**
> OCI는 컨테이너 생태계의 표준을 정의하여 Docker와 Podman 등 다양한 도구에서 호환성을 제공합니다. bootc는 OCI 표준을 활용하여 기존 컨테이너 도구와 레지스트리를 그대로 사용할 수 있으며, 커널과 initramfs를 포함한 부팅 가능한 컨테이너 이미지를 제공합니다. 이를 통해 운영체제를 효율적으로 업데이트할 수 있습니다.

---

![Image](image_0577d5e775ff.png)

![Image](image_9b300d305cd3.png)
...
허나 컨테이너와 bootc간에 무엇이 다른지 저희는 아직 다루지는 않았습니다. 다음 글에서 이 내용에 대해 정리하도록 하겠습니다.

오늘 가이드를 한마디로 요약해보자면, 정말 많은것을 추상화해서 가장 쉽게 축약한다면, “Docker쓰듯이 Bootc 를 쓸 수 있음!” 이라고 정리도 가능하겠네요..


![Image](image_a9183301131a.png)
