---
title: "Let’s Bootc! [9] - 데이터의 불변성은 어떻게 설정할까?"
date: 2026-01-25T13:02:00.000Z
draft: false
tags: ["Docker", "Infra"]
series: ["Meet The Bootc"]
description: "시스템의 불변성을 유지하면서 사용자 데이터를 효과적으로 관리하기 위해, S3 호환 오브젝트 스토리지를 홈서버에 구축하고, restic을 사용하여 백업 데이터를 암호화하는 방법을 제안합니다. 또한, systemd user timer를 통해 정기적인 백업 자동화를 구현하고, 복원 가능성을 확인하기 위한 리허설을 권장합니다. 이러한 접근 방식은 하드웨어에 종속되지 않고 개인 환경을 쉽게 복원할 수 있도록 합니다."
notion_id: "2f31bab9-e3f8-808e-b985-eb9c65e8b3b0"
notion_url: "https://www.notion.so/Let-s-Bootc-9-2f31bab9e3f8808eb985eb9c65e8b3b0"
---

# Let’s Bootc! [9] - 데이터의 불변성은 어떻게 설정할까?

> **Summary**
> 시스템의 불변성을 유지하면서 사용자 데이터를 효과적으로 관리하기 위해, S3 호환 오브젝트 스토리지를 홈서버에 구축하고, restic을 사용하여 백업 데이터를 암호화하는 방법을 제안합니다. 또한, systemd user timer를 통해 정기적인 백업 자동화를 구현하고, 복원 가능성을 확인하기 위한 리허설을 권장합니다. 이러한 접근 방식은 하드웨어에 종속되지 않고 개인 환경을 쉽게 복원할 수 있도록 합니다.

---

![Image](image_e213f2a8e2db.png)

![Image](image_56db83fd7620.png)
