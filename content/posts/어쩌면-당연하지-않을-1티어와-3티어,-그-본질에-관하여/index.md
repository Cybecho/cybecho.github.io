...
description: "3티어 아키텍처는 수직 확장과 수평 확장의 차이를 이해하고, 논리적 3티어와 물리적 3티어의 개념을 명확히 구분하는 것이 중요하다. 1티어는 모든 기능이 단일 서버에서 실행되는 반면, 3티어는 각 층이 독립적으로 확장 가능하다. 단일 서버에 컨테이너로 WEB, WAS, DB를 올리는 경우 논리적 3티어로 간주되지만 물리적으로는 1티어로 여겨질 수 있다."
